(ns adhesivemfg.phase
  "Phase 0->3 staged rollout for the ISIC 2029 (manufacture of other
  ...
  consequence (a reactor/mixing or filling/packaging-line maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `adhesivemfg.governor`'s `line-actuate-blocked-violations` HARD-
...
(defn verdict->disposition
  "Map an Adhesive Plant Operations Governor verdict to a base
