# Business Model: Manufacture of other chemical products n.e.c.
...
## Classification
- Repository: `cloud-itonami-isic-2029` ([github.com/cloud-itonami/cloud-itonami-isic-2029](https://github.com/cloud-itonami/cloud-itonami-isic-2029))
- ISIC Rev.5: `2029` — Manufacture of other chemical products n.e.c.
- Domain: `:adhesive/manufacturing`
- Social impact: :worker-safety :consumer-safety :environmental-safety
- Actor: `:adhesive-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :adhesive/manufacturing — who wants
...
One managed tenant (:adhesive/manufacturing):
...
- Do not bypass the `:adhesive-plant-operations-governor` for production decisions.
