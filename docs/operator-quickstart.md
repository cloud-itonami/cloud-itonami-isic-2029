# Operator Quickstart — Manufacture of other chemical products n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 2029** (`cloud-itonami-isic-2029`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2029.git
cd cloud-itonami-isic-2029
```
...
- Blueprint governor key: `bond-strength-governor`
- Likely source path: `src/**/bond-strength-governor.cljc`
