...
`cloud-itonami-isic-2029` accepts contributions to the OSS blueprint, capability
...
- Keep maintenance scheduling, shipment records and disclosures behind the Adhesive Plant Operations Governor.
- Treat workflows as high-risk: add tests for equipment-control gating,
  certification-decision gating, record integrity, safety-concern
